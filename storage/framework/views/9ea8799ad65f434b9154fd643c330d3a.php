                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                                ...
                                <a href="<?php echo e(route('agent.hotleads.create')); ?>" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    const table = $('#hotleads-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('agent.hotleads.index')); ?>",
            data: function(d) {
    ...
    $(document).on('click', '.view-btn', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('agent.hotleads.show', '')); ?>/" + hotleadId,
            type: 'GET',
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(route('agent.hotleads.destroy', '')); ?>/" + hotleadId,
                    type: 'DELETE',
                    data: {
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/agents/hotleads/index.blade.php ENDPATH**/ ?>