                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="<?php echo e(route('agent.appraisals.create')); ?>" class="btn btn-primary">
    ...
    <script>
        $(document).ready(function () {
            ...
            const table = $('#appraisals-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('agent.appraisals.index')); ?>",
                    data: function (d) {
            ...
            $(document).on('click', '.view-btn', function () {
                ...
                $.ajax({
                    url: "<?php echo e(route('agent.appraisals.show', '')); ?>/" + appraisalId,
                    type: 'GET',
                                        ...
                                        <div class="photo-gallery">
                                            ${appraisal.photos.map((photo, index) => `
                                                <div class="photo-item">
                                                    <img src="<?php echo e(asset('${photo}')); ?>" alt="Appraisal photo ${index + 1}" class="img-fluid rounded">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="photo-gallery">
                                            ${appraisal.property_photos.map((photo, index) => `
                                                <div class="photo-item">
                                                    <img src="<?php echo e(asset('${photo}')); ?>" alt="Property photo ${index + 1}" class="img-fluid rounded">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="photo-gallery">
                                            ${appraisal.comparable_photos.map((photo, index) => `
                                                <div class="photo-item">
                                                    <img src="<?php echo e(asset('${photo}')); ?>" alt="Comparable photo ${index + 1}" class="img-fluid rounded">
            ...
            $(document).on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo e(route('agent.appraisals.destroy', '')); ?>/" + appraisalId,
                            type: 'DELETE',
                            data: {
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/agents/conduct-appraisal/index.blade.php ENDPATH**/ ?>