  ...
  <div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="page-body1">
      ...
      <div class="row">
        ...
        <input type="hidden" name="booking_appraisal_id" value="<?php echo e($bookingAppraisal->id); ?>">
        <?php endif; ?>
            <!-- Vendors Section -->
            <div class="col-md-12">
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" id="vendor1_first_name" name="vendor1_first_name" type="text"
                value="<?php echo e($bookingData['vendor1_first_name'] ?? old('vendor1_first_name')); ?>"
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" id="vendor1_last_name" name="vendor1_last_name" type="text"
                value="<?php echo e($bookingData['vendor1_last_name'] ?? old('vendor1_last_name')); ?>"
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" id="vendor1_mobile" name="vendor1_mobile" type="text"
                value="<?php echo e($bookingData['vendor1_mobile'] ?? old('vendor1_mobile')); ?>" placeholder="" required>
              </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" id="vendor1_email" name="vendor1_email" type="email"
                value="<?php echo e($bookingData['vendor1_email'] ?? old('vendor1_email')); ?>" placeholder="" required>
              </div>
            </div>
            ...
            <div class="col-md-12">
              ...
              <textarea class="form-control" id="vendor1_address" name="vendor1_address" rows="3"
                required><?php echo e($bookingData['address'] ?? old('vendor1_address')); ?></textarea>
              </div>
            </div>
...
<div id="car-accommodation-spec" style="display: none; margin-top: 10px;margin-bottom:15px">
    <div class="mb-3">
        ...
        <input class="form-control" id="car_accommodation_spec" name="car_accommodation_spec" type="text" placeholder="">
              ...
              <div class="accordion-item">
                ...
                <div class="mb-2">
    <h5 class="mb-3"><?php echo e(auth()->guard('agent')->user()->name); ?> ,Recommended Trades </h5>
    <?php if($tradePersons->count() > 0): ?>
        <div class="trade-persons-list mb-3">
            <?php $__currentLoopData = $tradePersons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tradePerson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="trade_persons[]" 
                           value="<?php echo e($tradePerson->id); ?>" id="trade_person_<?php echo e($tradePerson->id); ?>">
                    <label class="form-check-label" for="trade_person_<?php echo e($tradePerson->id); ?>">
                        <?php echo e($tradePerson->name); ?> (<?php echo e($tradePerson->profession); ?>)
                    </label>
                </div>
    ...
    <?php else: ?>
        <div class="alert alert-info">
            ...
            <a href="<?php echo e(route('agent.trade-persons.index')); ?>" class="btn btn-sm btn-outline-primary">
                Add Trade Person
            </a>
        </div>
    <?php endif; ?>
...
<?php else: ?>
    <div class="alert alert-info">
        ...
        <a href="<?php echo e(route('agent.tempforconduct.index')); ?>" class="btn btn-sm btn-outline-primary">
            Add Email Template
        </a>
    </div>
<?php endif; ?>
...
function replaceTemplateVariables(content) {
    ...
    const agentName = '<?php echo e(auth()->guard("agent")->user()->name ?? ""); ?>';
    const agentMobile = '<?php echo e(auth()->guard("agent")->user()->phone ?? ""); ?>';
...
$('#email-content-preview').on('input', function() {
    ...
    $('#conductAppraisalForm').submit(function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('agent.appraisals.store')); ?>",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                ...
                Swal.fire({
                    ...
                    window.location.href = "<?php echo e(route('agent.appraisals.index')); ?>";
                });
            },
            error: function (xhr) {
                // Reset button state
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/agents/conduct-appraisal/create.blade.php ENDPATH**/ ?>