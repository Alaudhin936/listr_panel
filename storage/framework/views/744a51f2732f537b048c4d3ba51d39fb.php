                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                                ...
                                <a href="<?php echo e(route('agent.just-listed.create')); ?>" class="btn btn-primary">
...
$(document).ready(function() {
    ...
    const table = $('#just-listed-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('agent.just-listed.index')); ?>",
            data: function(d) {
...
function formatDate(dateString) {
    ...
    return date.toLocaleDateString('en-GB', { 
        ...
        $.ajax({
            url: "<?php echo e(route('agent.just-listed.show', '')); ?>/" + listingId,
            type: 'GET',
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(route('agent.just-listed.destroy', '')); ?>/" + listingId,
                    type: 'DELETE',
                    data: {
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/agents/just-listed/index.blade.php ENDPATH**/ ?>