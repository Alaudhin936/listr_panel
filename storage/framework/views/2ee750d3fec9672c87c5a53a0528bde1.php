<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/vendors/font-awesome.css')); ?>">
    ...
    <!-- Responsive css-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/responsive.css')); ?>"><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/others/others_layout/css.blade.php ENDPATH**/ ?>