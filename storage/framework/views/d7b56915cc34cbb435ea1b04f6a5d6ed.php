                ...
                <div>
                    ...
                    <div class="login-main">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('login')); ?>">Agency Login</a>
                            </li>
                            <li class="nav-item">
...
function sendLoginOTP() {
    ...
    fetch('<?php echo e(route("agent.login.send.otp")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
...
function resendLoginOTP() {
    ...
    fetch('<?php echo e(route("agent.login.resend.otp")); ?>', {
        method: 'POST',
...
function verifyLoginOTP() {
    ...
    fetch('<?php echo e(route("agent.login.verify.otp")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('others.others_layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/others/authentication/agent-login.blade.php ENDPATH**/ ?>