...
<div class="container-fluid">
    ...
    <div class="row g-4" id="tempForConduct-container">
        ...
        <div class="col-lg-6 col-xl-4" id="tempForConduct-card-<?php echo e($template->id); ?>">
...
$(document).ready(function() {
   ...
   const placeholders = [
    ...
    $('#tempForConductForm').submit(function(e) {
        ...
        const url = isEdit ? "<?php echo e(route('agent.tempforconduct.update', ':id')); ?>".replace(':id', $('#tempForConduct_id').val()) : "<?php echo e(route('agent.tempforconduct.store')); ?>";
    ...
    $(document).on('click', '.delete-tempForConduct', function() {
        ...
        if (confirm('🗑️ Are you sure you want to delete this template?\n\nThis action cannot be undone.')) {
            $.ajax({
                url: "<?php echo e(route('agent.tempforconduct.destroy', ':id')); ?>".replace(':id', templateId),
                method: 'DELETE',
                data: {
    ...
    $(document).on('click', '.toggle-status', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('agent.tempforconduct.toggle-status', ':id')); ?>".replace(':id', templateId),
            method: 'PATCH',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content')
            },
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/agents/templates-for-conduct/index.blade.php ENDPATH**/ ?>