...
<div class="container-fluid">
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('agent.dashboard')); ?>"><i data-feather="home"></i></a></li>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="weather-section d-flex align-items-center me-4">
                                    <h2 class="f-w-400 mb-0 me-3"> 
                                        <span><?php echo e(date('d')); ?><sup><i class="fa fa-circle-o f-10"></i></sup><?php echo e(date('M')); ?></span>
                                    </h2>
                                ...
                                <div class="welcome-section flex-grow-1">
                                    <h5 class="mb-1">
                                        <span>Welcome Back</span> <?php echo e(auth()->guard('agent')->user()->name); ?> 
                                    </h5>
                                    <span class="font-primary f-w-700 d-block"><?php echo e(date('l')); ?></span>
                        ...
                        <div class="col-md-4">
                            <div class="d-flex flex-column align-items-md-end align-items-start">
                                ...
                                <div class="badge badge-light-primary f-12 text-dark mb-3">
                                    ...
                                    <span id="txt"><?php echo e(date('H:i A')); ?></span>
                                </div>
                                
                                <!-- Active Leads -->
                                <div class="text-center text-md-end">
                                    <span class="badge badge-primary text-light fs-5 px-3 py-2 d-block mb-1"><?php echo e($hotLeadsCount + $bookingAppraisalsCount); ?></span>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 f-w-700"><?php echo e($hotLeadsCount); ?></h3>
                    </div>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 f-w-700"><?php echo e($bookingAppraisalsCount); ?></h3>
                    </div>
                ...
                <div class="chart-container d-flex flex-column justify-content-center px-3">
                    <div class="progress mb-2" style="height: 8px;">
                        <div class="progress-bar bg-success" 
                             style="width: <?php echo e($bookingAppraisalsCount > 0 ? min(($bookingAppraisalsCount / 20) * 100, 100) : 0); ?>%">
                        </div>
                    </div>
                </div>
                <div class="card-footer-info">
                    <div class="d-flex justify-content-between align-items-center px-3 pb-2">
                        <span class="badge badge-light-success">+<?php echo e($bookingAppraisalsCount); ?></span>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 f-w-700"><?php echo e($conductAppraisalsCount); ?></h3>
                    </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="card-footer-info">
                    <div class="d-flex justify-content-between align-items-center px-3 pb-2">
                        ...
                        <small class="text-muted"><?php echo e($conductAppraisalsCount); ?></small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-6">
        <div class="card stats-card h-100">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h3 class="mb-0 f-w-700"><?php echo e($justListedCount); ?></h3>
                    </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="card-footer-info">
                    <div class="d-flex justify-content-between align-items-center px-3 pb-2">
                        <span class="badge badge-light-info"><?php echo e($justListedData[5] ?? 0); ?></span>
                        <small class="text-muted">This Month</small>
                    </div>
                </div>
            </div>
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <div class="flex-grow-1">
                            ...
                            <h4>Latest <?php echo e($recentHotLeads->count()); ?></h4>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive theme-scrollbar">
                        <table class="table">
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $recentHotLeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <span class="f-w-600"><?php echo e($lead->vendor_first_name); ?> <?php echo e($lead->vendor_last_name); ?></span>
                                                <p class="mb-0 text-muted f-12"><?php echo e(Str::limit($lead->vendor_address, 30)); ?></p>
                                                <span class="badge badge-light-<?php echo e($lead->category == 'hot' ? 'danger' : 'primary'); ?> f-10">
                                                    <?php echo e(ucfirst($lead->category)); ?>

                                                </span>
                                            </div>
                                            <p class="f-w-500 mb-0 f-12 text-muted"><?php echo e($lead->created_at->diffForHumans()); ?></p>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="card-body">
                    <div class="activity-timeline">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <span class="f-w-600 d-block"><?php echo e($booking->vendor1_first_name); ?> <?php echo e($booking->vendor1_last_name); ?></span>
                                <p class="mb-0 f-12"><?php echo e(Str::limit($booking->address, 40)); ?></p>
                                <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($booking->appointment_date)->format('M d, Y')); ?></small>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="d-flex">
                    ...
                    <div class="activity-timeline todo-timeline">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex mt-0">
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-0"><?php echo e($hotLeadsData[5] ?? 0); ?> leads generated</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="f-w-600">
                                    <?php echo e($hotLeadsCount > 0 ? round(($conductAppraisalsCount / $hotLeadsCount) * 100, 1) : 0); ?>% 
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <span class="f-w-600">
                                    <?php echo e($conductAppraisalsCount > 0 ? round(($justListedCount / $conductAppraisalsCount) * 100, 1) : 0); ?>% 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Hot Leads',
                data: <?php echo json_encode($hotLeadsData, 15, 512) ?>,
                borderColor: '#FF6B35',
                ...
                data: <?php echo json_encode($bookingAppraisalsData, 15, 512) ?>,
                borderColor: '#28a745',
                ...
                data: <?php echo json_encode($conductAppraisalsData, 15, 512) ?>,
                borderColor: '#ffc107',
                ...
                label: 'Just Listed',
                data: <?php echo json_encode($justListedData, 15, 512) ?>,
                borderColor: '#17a2b8',
    ...
    const hotLeadsChart = new ApexCharts(document.querySelector("#hot-leads-chart"), {
        series: [{
            name: 'Hot Leads',
            data: <?php echo json_encode(array_slice($hotLeadsData, -6), 512) ?>
        }],
        chart: {
            type: 'area',
            height: 120,
    ...
    const conductChart = new ApexCharts(document.querySelector("#conduct-chart"), {
        series: [<?php echo e($conductAppraisalsCount); ?>, <?php echo e(max(10 - $conductAppraisalsCount, 0)); ?>],
        chart: {
            type: 'donut',
            height: 100
        },
    ...
    const justListedChart = new ApexCharts(document.querySelector("#just-listed-chart"), {
        series: [{
            name: 'Just Listed',
            data: <?php echo json_encode(array_slice($justListedData, -6), 512) ?>
        }],
        chart: {
            type: 'bar',
            height: 120,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ADMIN\Desktop\listr\resources\views/agents/agent-dashboard.blade.php ENDPATH**/ ?>