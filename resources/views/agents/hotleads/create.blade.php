                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('agent.hotleads.index') }}" class="btn btn-sm btn-outline-secondary">
                                    <i class="fas fa-arrow-left mr-1"></i> Back 
                                </a>
                            </div>
                            
                            <form id="create-hotlead-form" class="form theme-form" method="POST" action="{{ route('agent.hotleads.store') }}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <select name="followup_sms_template" id="sms_template_select" class="form-select">
                                                    ...
                                                    @forelse($smsTemplates as $template)
                                                        <option value="{{ $template->id }}" 
                                                            data-content="{{ $template->content }}">{{ $template->name }}</option>
                                                    @empty
                                                ...
                                                @if(count($smsTemplates) === 0)
                                                    <div class="mt-2">
                                                        <a href="{{ route('agent.templates.index') }}" class="btn btn-sm btn-outline-primary">
