...
<div class="container-fluid">
   <div class="card-header pb-0 p-3 d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="row g-4" id="templates-container">
        ...
        <div class="col-lg-6 col-xl-4" id="template-card-{{ $template->id }}">
...
$(document).ready(function() {
    ...
    $('#templateForm').submit(function(e) {
        ...
        const url = isEdit ? "{{ route('agent.templates.update', ':id') }}".replace(':id', $('#template_id').val()) : "{{ route('agent.templates.store') }}";
    ...
    $(document).on('click', '.delete-template', function() {
        ...
        if (confirm('🗑️ Are you sure you want to delete this template?\n\nThis action cannot be undone.')) {
            $.ajax({
                url: "{{ route('agent.templates.destroy', ':id') }}".replace(':id', templateId),
                method: 'DELETE',
                data: {
    ...
    $(document).on('click', '.toggle-status', function() {
        ...
        $.ajax({
            url: "{{ route('agent.templates.toggle-status', ':id') }}".replace(':id', templateId),
            method: 'PATCH',
            data: {
                _token: $('meta[name="csrf-token"]').attr('content')
            },
