...
@if(isset($appraisalData))
    <input type="hidden" name="conduct_appraisal_id" value="{{ $appraisal->id }}">
@endif
...
@endif
                                            ...
                                            <!-- Add vendor? -->
                                            <div class="col-md-12">
                                                <label class="form-label" for="has_additional_vendor">Add vendor?</label>
                                                <div class="mb-3 m-t-15 custom-radio-ml">
                                                    ...
                                                    <div class="form-check radio radio-primary">
                                                        <input class="form-check-input" id="has_additional_vendor_no"
                                                            type="radio" name="has_additional_vendor" value="0" checked>
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select digits" id="main_contact" name="main_contact"
                                                        >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" id="main_contact_mobile"
                                                                    name="main_contact_mobile" type="text" placeholder="">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input class="form-control" id="main_contact_email"
                                                                    name="main_contact_email" type="email" placeholder="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <div class="form-check checkbox mb-0">
                                                        <input class="form-check-input" id="privacy_consent" type="checkbox"
                                                            name="privacy_consent" value="1" >
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="flush-headingCampaign">
                                                            <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                data-bs-target="#flush-collapseCampaign" aria-expanded="false"
                                                                aria-controls="flush-collapseCampaign">
                                                                Campaign Overview
                                                            </button>
                                                        </h2>
                                                        <div id="flush-collapseCampaign" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select digits" id="method_of_sale"
                                                                        ...
                                                                        <option value="Expression's Of Interest">Expression's Of Interest
                                                                        </option>
                                                                        <option value="Private Sale">Private Sale</option>
                                                                        <option value="Off Market To Start. Auction if needed.">Off Market
                                                                ...
                                                                <div class="sale-option" id="input-auction" style="display: none;">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Auction date</label>
                                                                        <input class="form-control digits" type="date" name="auction_date"
                                                                            value="{{ date('Y-m-d') }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">First Open for Inspection</label>
                                                                        <input class="form-control digits" type="date"
                                                                            name="first_open_date" value="{{ date('Y-m-d') }}">
                                                                    </div>
                                                                </div>

                                                                <div class="sale-option" id="input-expression" style="display: none;">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Expression's of Interest Closing
                                                                            Date</label>
                                                                        <input class="form-control digits" type="date"
                                                                            name="expressions_closing_date" value="{{ date('Y-m-d') }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">First Open for Inspection</label>
                                                                        <input class="form-control digits" type="date"
                                                                ...
                                                                <div class="sale-option" id="input-private" style="display: none;">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">First Open for Inspection</label>
                                                                        <input class="form-control digits" type="date"
                                                                            name="first_open_date" value="{{ date('Y-m-d') }}">
                                                                ...
                                                                <div class="mb-3 sale-option" id="input-offmarketauction"
                                                                    style="display: none;">
                                                                    <label class="form-label">Has a potential auction date been
                                                                        discussed?</label>
                                                                    <input type="text" class="form-control"
                                                                        name="potential_auction_discussed" placeholder="">
                                                                </div>

                                                                <div class="mb-3 sale-option" id="input-forthcoming" style="display: none;">
                                                                    <label class="form-label">Auction date (if known)</label>
                                                                    <input class="form-control digits" type="date" name="forthcoming_auction_date"
                                                                        value="{{ date('Y-m-d') }}">
                                                                </div>

                                                                <div class="mb-3 sale-option" id="input-other" style="display: none;">
                                                                    <label class="form-label">If Other, Please Specify Method of Sale
                                                                        Details:</label>
                                                                    <textarea class="form-control" name="other_method_details"
                                                                        rows="3"></textarea>
                                                                </div>

                                                                <!-- Campaign Overview Notes (Requirement 46) -->
                                                                <div class="mb-3">
                                                                    <label class="form-label">Campaign Overview Notes</label>
                                                                    <textarea class="form-control" name="campaign_overview_notes" rows="3" placeholder="Enter campaign overview notes here..."></textarea>
                                                                </div>

                                                                <!-- Who should receive campaign overview (Requirement 56) -->
                                                                <div class="mb-3">
                                                                    <label class="form-label">Who should receive the campaign overview?</label>
                                                                    <select class="form-select digits" id="campaign_recipient" name="campaign_recipient">
                                                                        <option value="">Please Select</option>
                                                                ...
                                                                <div class="mb-3" id="custom_email_input" style="display: none;">
                                                                    <label class="form-label">Custom Email Address</label>
                                                                    <input type="email" class="form-control" name="custom_email" placeholder="Enter email address">
                                                                    <button type="button" class="btn btn-sm btn-outline-primary mt-2" id="save_email_btn">
                                                                        <i class="fas fa-save me-1"></i> Save as future option
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select digits" id="first_agent" name="first_agent"
                                                                        >
                                                                        <option value="">Please Select</option>
                                                                        <option value="Rob Sheahan" selected>Rob Sheahan</option>
                                                                        ...
                                                                        <option value="Shaun Purumal">Shaun Purumal</option>
                                                                ...
                                                                <div class="mb-3" id="other-agent-input" style="display: none;">
                                                                    <label class="form-label">1st Agent - Other:</label>
                                                                    <input type="text" class="form-control" name="first_agent_other"
                                                                        placeholder="">
                                                                </div>
                                                                ...
                                                                <!-- Hidden input field for 'Other' -->
                                                                <div class="mb-3" id="other-second-agent-input" style="display: none;">
                                                                    <label class="form-label">2nd Agent - Other:</label>
                                                                    <input type="text" class="form-control" name="second_agent_other"
                                                                        placeholder="">
                                                                </div>
                                                                ...
                                                                <div class="mb-3" id="third-agent-other-input"
                                                                    ...
                                                                    <input type="text" class="form-control" name="third_agent_other"
                                                                        placeholder="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label">Select Marketing Package</label>
                                                                    <select class="form-select digits" id="marketing_package" name="marketing_package">
                                                                        <option value="">Please Select</option>
                                                                        <option value="package1">Premium Package - $999</option>
                                                                        <option value="package2">Standard Package - $699</option>
                                                                        <option value="package3">Basic Package - $399</option>
                                                                        <option value="custom">Book Services Individually</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div id="individual-services" style="display: none;">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Photography Services</label>
                                                                        ...
                                                                        <div class="form-check checkbox mb-0">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="checkbox1">Premium Dust Photos 12</label>
                                                                        </div>
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input service-checkbox"
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="checkbox2">Premium Dust Photos 15</label>
                                                                        </div>
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input service-checkbox"
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="checkbox3">Premium Day Photos 12</label>
                                                                        </div>
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input service-checkbox"
                                                                        ...
                                                                        <div class="form-check checkbox mb-0">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="checkbox7">Floorplan & Siteplan</label>
                                                                        </div>
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input service-checkbox"
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="checkbox8">Floorplan Redraw Only</label>
                                                                        </div>
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input service-checkbox"
                                                                                id="checkbox9" type="checkbox"
                                                                                name="photography_services[]" value="Other">
                                                                            <label class="form-check-label"
                                                                    ...
                                                                    <div class="mb-3" id="other-input-field"
                                                                        ...
                                                                        <textarea class="form-control"
                                                                            name="other_photography_requirements"
                                                                            rows="3"></textarea>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3" id="service-select-field"
                                                                        ...
                                                                        <label class="form-label">Preferred Photography
                                                                            Supplier</label>
                                                                        <select class="form-select" name="photography_supplier">
                                                                            <option value="">Please Select</option>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input copywriting-checkbox"
                                                                        ...
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input copywriting-checkbox"
                                                                                ...
                                                                                name="copywriting_services[]" value="In-house">
                                                                            <label class="form-check-label"
                                                                                for="checkbox11">Copywriting - In-house</label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3" id="copywriting-dropdown"
                                                                        ...
                                                                        <label class="form-label">Preferred Photography
                                                                            Supplier</label>
                                                                        <select class="form-select" name="copywriting_supplier">
                                                                            <option value="">Please Select</option>
                                                                            <option value="X2A Media">X2A Media</option>
                                                                        </select>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3 m-t-15">
                                                                        ...
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input floorplan-checkbox"
                                                                        ...
                                                                        <div class="form-check checkbox mb-0">
                                                                            <input class="form-check-input floorplan-checkbox"
                                                                                ...
                                                                                name="floorplan_services[]" value="Redraw Only">
                                                                            <label class="form-check-label"
                                                                        ...
                                                                        <div class="form-check checkbox mb-0">
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="checkbox14">Virtual Walk Thru Tour</label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div id="floorplan-input" class="mb-3"
                                                                        ...
                                                                        <label class="form-label">Preferred Photography
                                                                            Supplier</label>
                                                                        <select class="form-select" name="floorplan_supplier">
                                                                            <option value="">Please Select</option>
                                                                            <option value="X2A Media">X2A Media</option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="form-check radio radio-primary">
                                                                        <input class="form-check-input" id="supplier_pref_default"
                                                                            type="radio" name="supplier_preferences" value="default" checked>
                                                                        <label class="form-check-label"
                                                                            for="supplier_pref_default">Use my preferred default suppliers</label>
                                                                    </div>
                                                                    <div class="form-check radio radio-primary">
                                                                        <input class="form-check-input" id="supplier_pref_review"
                                                                            type="radio" name="supplier_preferences" value="review">
                                                                        <label class="form-check-label"
                                                                            for="supplier_pref_review">Review and change suppliers before booking</label>
                                                                    </div>
                                                                </div>

                                                                <!-- Property Access for Suppliers (Requirements 58-61) -->
                                                                <div class="mb-3">
                                                                    <label class="form-label">How will the supplier access the property?</label>
                                                                    <select class="form-select digits" id="supplier_access_method" name="supplier_access_method">
                                                                        <option value="">Please Select</option>
                                                                        <option value="Meet Agent on Site">Meet Agent on Site</option>
                                                                        <option value="Meet Vendor on Site">Meet Vendor on Site</option>
                                                                        <option value="Vacant">Vacant</option>
                                                                        <option value="Meet Renter on Site">Meet Renter on Site</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div id="vacant-access-options" style="display: none;">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Vacant Property Access</label>
                                                                        <select class="form-select digits" id="vacant_access_type" name="vacant_access_type">
                                                                            <option value="">Please Select</option>
                                                                            <option value="Access via code">Access via code</option>
                                                                            <option value="Access via keysafe">Access via keysafe</option>
                                                                            <option value="Confirm with agent before attending">Confirm with agent before attending</option>
                                                                            <option value="Pick up key from office">Pick up key from office</option>
                                                                        </select>
                                                                    </div>

                                                                    <!-- Code input -->
                                                                    <div id="access-code-input" class="mb-3" style="display: none;">
                                                                        <label class="form-label">Keysafe Code</label>
                                                                        <input type="text" class="form-control" name="keysafe_code" placeholder="Enter code">
                                                                    </div>

                                                                    <!-- Keysafe location -->
                                                                    <div id="keysafe-location-input" class="mb-3" style="display: none;">
                                                                        <label class="form-label">Key safe location</label>
                                                                        <select class="form-select digits" id="keysafe_location" name="keysafe_location">
                                                                            <option value="">Please Select</option>
                                                                            <option value="Front security door">Front security door</option>
                                                                            <option value="Veranda Railing">Veranda Railing</option>
                                                                            ...
                                                                            <option value="Near Back Entrance">Near Back Entrance</option>
                                                                            <option value="Other">Other</option>
                                                                        </select>
                                                                    </div>

                                                                    <!-- Other keysafe location -->
                                                                    <div id="other-keysafe-location" class="mb-3" style="display: none;">
                                                                        <label class="form-label">Other keysafe location</label>
                                                                        <input type="text" class="form-control" name="other_keysafe_location" placeholder="Specify location">
                                                                    </div>
                                                                </div>

                                                                <!-- Optional message for suppliers (Requirement 62) -->
                                                                <div class="mb-3">
                                                                    <label class="form-label">Optional Message for Suppliers</label>
                                                                    <textarea class="form-control" name="supplier_message" rows="3" placeholder="Any special instructions for suppliers..."></textarea>
                                                                </div>
                                                                ...
                                                                <div id="marketing-input" class="mb-3"
                                                                    ...
                                                                    <textarea class="form-control"
                                                                        name="other_marketing_details" rows="3"></textarea>
                                                                </div>

                                                                <!-- Other Suppliers (Requirement 48) -->
                                                                <div class="mb-3 m-t-15 custom-radio-ml">
                                                                    <label class="form-label">Do you need to refer any other
                                                                ...
                                                                <div id="supplier-add-btn" style="display: none;" class="mb-3">
                                                                    <button type="button" class="btn btn-outline-primary" id="add-supplier-btn">
                                                                    ...
                                                                    <div class="mb-3 m-t-15 custom-radio-ml">
                                                                        ...
                                                                        <div class="form-check radio radio-primary">
                                                                            <input class="form-check-input" id="radio9"
                                                                                type="radio" name="supplier_contact_method"
                                                                                value="SMS">
                                                                            <label class="form-check-label"
                                                                ...
                                                                <div class="mb-3 m-t-15">
                                                                    <label class="form-label">How would you like to schedule
                                                                ...
                                                                <div id="input15" class="mb-3" style="display: none;">
                                                                ...
                                                                <div id="input16" class="mb-3" style="display: none;">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Requested Date for Floorplan & Copywriting</label>
                                                                        <input class="form-control digits" type="date"
                                                                            name="floorplan_copywriting_date" value="{{ date('Y-m-d') }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Requested Date for Photography</label>
                                                                        <input class="form-control digits" type="date"
                                                                            name="photography_date" value="{{ date('Y-m-d') }}">
                                                                    </div>
                                                                </div>
                                                                <div id="input19" class="mb-3" style="display: none;">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label class="form-label">Who should handle the supplier bookings?</label>
                                                                    <select class="form-select" id="booking_handler" name="booking_handler">
                                                                        <option value="">Please Select</option>
                                                                        <option value="Vendor to receive calls from Suppliers">Vendor to receive calls from Suppliers</option>
                                                                        <option value="Agent - I'll coordinate directly">Agent - I'll coordinate directly</option>
                                                                        <option value="Admin / PA will confirm all appointments">Admin / PA will confirm all appointments</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input" id="save_as_default" type="checkbox"
                                                                            name="save_as_default" value="1">
                                                                        <label class="form-check-label" for="save_as_default">Save this as default for all listings</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" id="occupancyStatus"
                                                                        ...
                                                                        <option value="Currently Occupied, Vacant in sale.">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select" id="accessToProperty"
                                                                        ...
                                                                        <option value="">Please Select</option>
                                                                        <option value="Owner to meet">Owner to meet</option>
                                                                        <option value="Via Keysafe">Via Keysafe</option>
                                                                        <option value="Agent to meet">Agent to meet</option>
                                                                ...
                                                                <div id="access-other-input" class="mb-3"
                                                                    ...
                                                                    <label class="form-label">Specify Other Access
                                                                        Arrangements:</label>
                                                                    <textarea class="form-control"
                                                                        name="other_access_arrangements"
                                                                        rows="3"></textarea>
                                                                </div>
                                                                ...
                                                                <div id="other-lockbox-input" class="mb-3"
                                                                    ...
                                                                    <div class="mb-3 m-t-15 custom-radio-ml">
                                                                        ...
                                                                        <div class="form-check radio radio-primary">
                                                                            <input class="form-check-input" id="radio12"
                                                                                type="radio" name="key_option" value="Type">
                                                                            <label class="form-check-label"
                                                                    ...
                                                                    <div id="typeInput" class="mb-3" style="display: none;">
                                                                ...
                                                                <!-- Hidden input field -->
                                                                <div class="mb-3" id="alarmInputDiv" style="display: none;">
                                                            ...
                                                            <div class="accordion-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="form-check checkbox mb-0">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="checkbox25">Mortgage Broker - Jacob</label>
                                                                    </div>
                                                                ...
                                                                <!-- Radio section -->
                                                                <div class="mb-3" id="radioSection" style="display: none;">
                                                                    ...
                                                                    <div class="form-check radio radio-primary">
                                                                        <input class="form-check-input" id="radio16"
                                                                            ...
                                                                            <label class="form-check-label"
                                                                                for="radio16">Tradesperson to contact Agent</label>
                                                                    </div>
                                                                    <div class="form-check radio radio-primary">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="radio17">Tradesperson to contact Vendor</label>
                                                                    </div>
                                                                    <div class="form-check radio radio-primary">
                                                                        <input class="form-check-input" id="radio18"
                                                                            type="radio" name="trades_contact_method"
                                                                            value="Vendor to contact Tradesperson">
                                                                        <label class="form-check-label" for="radio18">Vendor
                                                                            to contact Tradesperson</label>
                                                                    </div>
                                                                </div>

                                                                <!-- Privacy consent for option 2 -->
                                                                <div id="privacy-consent-div" class="mb-3" style="display: none;">
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input" id="privacy_consent_trades" type="checkbox"
                                                                            name="privacy_consent_trades" value="1">
                                                                        <label class="form-check-label" for="privacy_consent_trades">
                                                                            I consent to my contact details being shared with approved suppliers to assist in marketing and preparing my property for sale.
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input form-check-property1"
                                                                    ...
                                                                    <div class="form-check checkbox mb-0">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="checkbox34">Window Cleaner - Scott</label>
                                                                    </div>
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input form-check-property1"
                                                                    ...
                                                                    <div class="form-check checkbox mb-0">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="checkbox36">Flooring - Cam Desmier</label>
                                                                    </div>
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input form-check-property1"
                                                                    ...
                                                                    <div class="form-check checkbox mb-0">
                                                                        ...
                                                                        <label class="form-check-label"
                                                                            for="checkbox41">Painting - Dava Zennaro</label>
                                                                    </div>
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input form-check-property1"
                                                                    ...
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input form-check-property1"
                                                                            ...
                                                                            value="Mortgage Broker - Jacob">
                                                                        <label class="form-check-label"
                                                                            for="checkbox50">Mortgage Broker - Jacob</label>
                                                                    </div>
                                                                    <div class="form-check checkbox mb-0">
                                                                        <input class="form-check-input form-check-property1"
                                                                ...
                                                                <div class="mb-3" id="generalInput3" style="display: none;">
                                                                    ...
                                                                    <div class="form-check radio radio-primary">
                                                                        <input class="form-check-input" id="radio20"
                                                                            type="radio" name="trades_access_method"
                                                                            value="vendorContact">
                                                                        <label class="form-check-label" for="radio20">Vendor
                                                                            to contact Tradesperson</label>
                                                                    </div>
                                                                    ...
                                                                    <div id="vacantInput3" style="margin-top: 10px;">
                                                                        ...
                                                                        <div class="form-check radio radio-primary">
                                                                            <input class="form-check-input" id="radio23"
                                                                                type="radio"
                                                                                name="vacant_access_instructions"
                                                                                value="Code">
                                                                            <label class="form-check-label"
                                                                        ...
                                                                        <div class="form-check radio radio-primary">
                                                                            <input class="form-check-input" id="radio24"
                                                                                type="radio"
                                                                                name="vacant_access_instructions"
                                                                                value="Pending">
                                                                            <label class="form-check-label"
                                                                        ...
                                                                        <div class="form-check radio radio-primary">
                                                                            <input class="form-check-input" id="radio25"
                                                                                type="radio"
                                                                                name="vacant_access_instructions"
                                                                                value="MeetAgent">
                                                                            <label class="form-check-label"
                                                                        ...
                                                                        <div id="codeInputField"
                                                                            ...
                                                                            <label class="form-label">Code for Key
                                                                                safe</label>
                                                                            <input type="text" class="form-control"
                                                                                name="vacant_access_code" placeholder="">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-3" id="otherTradesTextarea"
                                                                    ...
                                                                    <label class="form-label">Specify Other Trades
                                                                        Needed:</label>
                                                                    <textarea class="form-control"
                                                                        name="other_trades_needed" rows="3"
                                                                    ...
                                                                    <div class="mb-3" id="painterTextarea"
                                                                        ...
                                                                        <label class="form-label">Painting notes (if
                                                                            applicable)</label>
                                                                        <textarea class="form-control" name="painting_notes"
                                                                    ...
                                                                    <div class="mb-3" id="gardenerTextarea"
                                                                        ...
                                                                        <label class="form-label">Gardening notes (if
                                                                            applicable)</label>
                                                                        <textarea class="form-control" name="gardening_notes"
                                                                            rows="3" placeholder=""></textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#alarmSelect').change(function() {
                const val = $(this).val();
                $('#alarmInputDiv').toggle(val === 'Yes' || val === 'Yes - but won\'t be switched on during inspections');
            });
            ...
            $('#justListedForm').submit(function(e) {
                ...
                if (!$('#property_address').val() || !$('#vendor1_first_name').val() || !$('#vendor1_last_name').val() || 
                ...
                if ($('input[name="trades_contact_method"]:checked').val() === 'Tradesperson to contact Vendor' && 
                        ...
                        if (response.success) {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = "{{ route('agent.just-listed.index') }}";
                                }
                            });
                        } else {
                            Swal.fire({
