...
$(document).ready(function() {
    ...
    const table = $('#just-listed-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('agency.just-listed.index') }}",
            data: function(d) {
        ...
        responsive: true,
        language: {
            emptyTable: 'No just listed properties found',
    ...
    return date.toLocaleDateString('en-GB', { 
        ...
        $.ajax({
            url: "{{ route('agency.just-listed.show', '') }}/" + listingId,
            type: 'GET',
            success: function(response) {
                if (response.success) {
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.vendor1_first_name} ${listing.vendor1_last_name}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.vendor1_mobile || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.vendor1_email || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.vendor1_address || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            ${listing.has_additional_vendor ? `
                            <div class="col-md-6">
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Name</div>
                                        <div>${listing.vendor2_first_name} ${listing.vendor2_last_name}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Mobile</div>
                                        <div>${listing.vendor2_mobile || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Email</div>
                                        <div>${listing.vendor2_email || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            ` : ''}
                    ...
                    const mainContact = `
                        <div class="row">
                            <div class="col-12">
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Main Point of Contact</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                        <i class="fas fa-user"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Name</div>
                                        <div>${listing.main_contact_first_name} ${listing.main_contact_last_name}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Mobile</div>
                                        <div>${listing.main_contact_mobile || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Email</div>
                                        <div>${listing.main_contact_email || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Method of Sale</div>
                                        <div>${listing.method_of_sale || 'N/A'} ${listing.other_method_details ? '(' + listing.other_method_details + ')' : ''}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.formatted_auction_date || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">First Open Date</div>
                                        <div>${listing.formatted_first_open_date || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Expressions Closing Date</div>
                                        <div>${listing.formatted_expressions_closing_date || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Potential Auction Discussed</div>
                                        <div>${listing.potential_auction_discussed || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">First Agent</div>
                                        <div>${listing.first_agent === 'other' ? listing.first_agent_other : listing.first_agent}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Second Agent</div>
                                        <div>${listing.second_agent === 'other' ? listing.second_agent_other : listing.second_agent}</div>
                                    </div>
                                </div>
                            </div>
                            ${listing.has_third_agent ? `
                            <div class="col-md-6">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                        <i class="fas fa-user-tie"></i>
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Third Agent</div>
                                        <div>${listing.third_agent === 'other' ? listing.third_agent_other : listing.third_agent}</div>
                                    </div>
                                </div>
                            </div>
                            ` : ''}
                    ...
                    // Format marketing services
                    const marketingServices = `
                        <div class="row">
                            <div class="col-md-4">
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Photography</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="feature-tags">
                                            ${Array.isArray(listing.photography_services) && listing.photography_services.length > 0 ? 
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.photography_supplier || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.other_photography_requirements || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Copywriting</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Services</div>
                                        <div class="feature-tags">
                                            ${Array.isArray(listing.copywriting_services) && listing.copywriting_services.length > 0 ? 
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Supplier</div>
                                        <div>${listing.copywriting_supplier || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Floorplan</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Services</div>
                                        <div class="feature-tags">
                                            ${Array.isArray(listing.floorplan_services) && listing.floorplan_services.length > 0 ? 
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Supplier</div>
                                        <div>${listing.floorplan_supplier || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ${listing.other_marketing_required ? `
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Other Marketing Required</div>
                                        <div>${listing.other_marketing_details || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    // Format other suppliers
                    const otherSuppliers = listing.other_supplier_needed ? `
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.supplier_name || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.supplier_category || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.supplier_requirements || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Mobile</div>
                                        <div>${listing.supplier_mobile || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Email</div>
                                        <div>${listing.supplier_email || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ` : '<div class="text-muted">No other suppliers required</div>';
                            ...
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="feature-tags">
                                            ${Array.isArray(listing.appointment_schedule_options) && listing.appointment_schedule_options.length > 0 ? 
                                                listing.appointment_schedule_options.map(item => `<span class="feature-tag">${item}</span>`).join('') : 
                                                'N/A'}
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">All Appointments Date</div>
                                        <div>${listing.formatted_all_appointments_date || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Photography Date</div>
                                        <div>${listing.formatted_photography_date || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Video Date</div>
                                        <div>${listing.formatted_video_date || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Custom Booking Instructions</div>
                                        <div>${listing.custom_booking_instructions || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Proofs Destination</div>
                                        <div>${listing.proofs_destination || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Occupancy Status</div>
                                        <div>${listing.occupancy_status || 'N/A'}</div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Renter's Name</div>
                                        <div>${listing.renters_name || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Renter's Phone</div>
                                        <div>${listing.renters_phone || 'N/A'}</div>
                                    </div>
                                </div>
                                ` : ''}
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Property Access</div>
                                        <div>${listing.property_access || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Other Access Arrangements</div>
                                        <div>${listing.other_access_arrangements || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Keysafe Type</div>
                                        <div>${listing.keysafe_type || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Keysafe Code</div>
                                        <div>${listing.keysafe_code || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Keysafe Location</div>
                                        <div>${listing.keysafe_location === 'other' ? listing.other_keysafe_location : listing.keysafe_location}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Alarm System</div>
                                        <div>${listing.alarm_system || 'N/A'} ${listing.alarm_instructions ? '(' + listing.alarm_instructions + ')' : ''}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">No Access Required</div>
                                        <div class="feature-tags">
                                            ${Array.isArray(listing.trades_no_access) && listing.trades_no_access.length > 0 ? 
                            ...
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Require Access</div>
                                        <div class="feature-tags">
                                            ${Array.isArray(listing.trades_require_access) && listing.trades_require_access.length > 0 ? 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Other Trades Needed</div>
                                        <div>${listing.other_trades_needed || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Contact Method</div>
                                        <div>${listing.trades_contact_method || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Vacant Access Instructions</div>
                                        <div>${listing.vacant_access_instructions || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Painting Notes</div>
                                        <div>${listing.painting_notes || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Gardening Notes</div>
                                        <div>${listing.gardening_notes || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Listing Status</div>
                                        <div>${listing.listing_status || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Open Home Attendance</div>
                                        <div>${listing.open_home_attendance || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Privacy Consent</div>
                                        <div>${listing.privacy_consent ? 'Yes' : 'No'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    const tasks = `
                        <div class="row">
                            <div class="col-md-6">
                                ${listing.assign_task ? `
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Primary Task</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.task_template || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.task_message || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.task_recipient || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${listing.task_method || 'N/A'}</div>
                                    </div>
                                </div>
                                ` : ''}
                            </div>
                            <div class="col-md-6">
                                ...
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Additional Task</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                        <i class="fas fa-tasks"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Template</div>
                                        <div>${listing.additional_task_template || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Message</div>
                                        <div>${listing.additional_task_message || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Recipient</div>
                                        <div>${listing.additional_task_recipient || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Method</div>
                                        <div>${listing.additional_task_method || 'N/A'}</div>
                                    </div>
                                </div>
                                ` : ''}
                            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <div class="form-control bg-light border fw-semibold" style="padding-top: 1.625rem;">
 ${formatDate(listing.auction_date)}                                                </div>
                                                <label class="text-muted fw-medium">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <div class="form-control bg-light border fw-semibold" style="padding-top: 1.625rem;">
    ${formatDate(listing.first_open_date)}                                                </div>
                                                <label class="text-muted fw-medium">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <div class="form-control bg-light border fw-semibold" style="padding-top: 1.625rem;">
 ${formatDate(listing.expressions_closing_date)}                                                </div>
                                                <label class="text-muted fw-medium">
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('agency.just-listed.destroy', '') }}/" + listingId,
                    type: 'DELETE',
                    data: {
                        _token: "{{ csrf_token() }}"
                    },
