                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                                <h4 class="hot-head1"><i class="fas fa-user-plus mr-2"></i>Create New Agent</h4>
                                <a href="{{ route('agency.agents.index') }}" class="btn btn-outline-secondary">
                                    <i class="fas fa-arrow-left mr-1"></i> Back to List
                                </a>
                            </div>
                            
                            <form id="create-agent-form" class="form theme-form" method="POST" action="{{ route('agency.agents.store') }}">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="address_line1" name="address_line1" type="text" placeholder="Enter address line 1" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="address_line2" name="address_line2" type="text" placeholder="Enter address line 2 (optional)">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="state" name="state" type="text" placeholder="Enter state" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="zipcode" name="zipcode" type="text" placeholder="Enter zip code" required>
                                            </div>
                                        </div>
...
$(document).ready(function() {
    $('#create-agent-form').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                submitBtn.prop('disabled', false).html('<i class="fas fa-save mr-1"></i> Create Agent');
