        ...
        <select class="form-select" id="agentFilter">
            ...
            @endforeach
                                ...
                                <div class="table-responsive">
                                    <table id="booking-appraisals-table" class="table table-hover" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th>Agent Name</th>
                                                <th>Vendor</th>
...
$(document).ready(function() {
    ...
    const table = $('#booking-appraisals-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "{{ route('agency.booking-appraisals.index') }}",
            data: function(d) {
        ...
        columns: [
            ...
            { 
                ...
                name: 'status',
                render: function(data, type, row) {
                    const badgeClass = row.category === 'urgent' ? 'badge-hot' : 'badge-warm';
                    return `<span class="badge ${badgeClass}">${row.category ? row.category.charAt(0).toUpperCase() + row.category.slice(1) : 'N/A'}</span>`;
                }
            },
            { 
                data: 'action', 
 ...
 $('#agentFilter').select2({
    ...
    $(document).on('click', '.view-btn', function() {
        ...
        $.ajax({
            url: "{{ route('agency.booking-appraisals.show', '') }}/" + appraisalId,
            type: 'GET',
            success: function(response) {
                if (response.success) {
                            ...
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${appraisal.property_type || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${appraisal.land_size || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Parking</div>
                                        <div>${appraisal.under_cover_parking || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${appraisal.condition || 'N/A'}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Appointment Date</div>
                                        <div>${appraisal.appointment_date || 'Not scheduled'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Appointment Time</div>
                                        <div>${appraisal.appointment_time || 'Not specified'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>
                                            ${appraisal.send_confirmation_sms ? '<span class="badge bg-success me-1">SMS</span>' : ''}
                                            ${appraisal.send_confirmation_email ? '<span class="badge bg-success">Email</span>' : ''}
                                            ${!appraisal.send_confirmation_sms && !appraisal.send_confirmation_email ? 'None' : ''}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <span class="badge ${appraisal.category === 'urgent' ? 'badge-hot' : 'badge-warm'}">
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${appraisal.agent ? appraisal.agent.name : 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${new Date(appraisal.created_at).toLocaleString()}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    const additionalInfo = `
                        <div class="row">
                            <div class="col-md-6">
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Lead Information</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${appraisal.lead_source || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div>${appraisal.lead_source_notes || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Selling Status</div>
                                        <div>${appraisal.is_vendor_selling ? 'Yes' : 'No'}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h6 class="fw-bold mb-3 text-uppercase text-sm text-muted">Vendor Plans</h6>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                        <i class="fas fa-map-marker-alt"></i>
                                    </div>
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">Moving To</div>
                                        <div>${appraisal.moving_to || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex mb-3">
                                    <div class="flex-shrink-0 text-muted me-3">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="small text-muted">When Listing</div>
                                        <div>${appraisal.when_listing || 'N/A'}</div>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-muted me-3">
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('agency.booking-appraisals.destroy', '') }}/" + appraisalId,
                    type: 'DELETE',
                    data: {
                        _token: "{{ csrf_token() }}"
                    },
