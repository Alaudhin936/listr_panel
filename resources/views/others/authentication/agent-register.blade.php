                        ...
                        <div id="step1" class="form-step active">
                            <form class="theme-form" id="registrationForm">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="name" required placeholder="Enter your full name" value="{{ old('name') }}">
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="email" name="email" required placeholder="agent@example.com" value="{{ old('email') }}">
                                            @error('email')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="address_line1" required placeholder="Enter your primary address" value="{{ old('address_line1') }}">
                                    @error('address_line1')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="address_line2" placeholder="Apartment, suite, etc." value="{{ old('address_line2') }}">
                                    @error('address_line2')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <p class="mt-4 mb-0 text-center">Already have account?<a class="ms-2" href="{{ route('agent.login.page') }}">Sign In</a></p>
                            </form>
                        </div>
